! This is how the builtin libglide is called by the glide interface.  This file
! exists because the autotools only handle fortran 90/95 name mangling when
! modules are not involved: hence wrappers that have the same names as their
! counterparts in the modules
